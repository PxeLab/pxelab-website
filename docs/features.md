...
**相关文档**: [产品定位](product.md) | [架构概述](guides/architecture.md)
...
- React 19 SPA，亮色/暗色/跟随系统三态主题，主色与圆角可调
- 中英双语界面
- 实时数据刷新（SSE 事件流）
- 响应式设计，支持移动端
...
- **初始化脚本 / 脚本管理**：自定义引导脚本资产
- **PxeLab Hub**：社区共享的基线脚本、启动模板与配置方案，一键导入
...
| 工具 | 说明 |
|------|------|
| **事件日志** | 实时事件流（DHCP / 引导 / 唤醒 / 带外操作），SSE 推送 |
| **审计日志** | 跟踪所有配置变更 |

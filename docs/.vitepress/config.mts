...
// 「开始使用」区域侧边栏:产品/快速开始/教程/参考文档/其他
const gettingStartedGroups: SidebarGroupDef[] = [
  {
    zh: '产品',
    en: 'Product',
    items: [
...
// 「使用指南」区域侧边栏
const guidesGroups: SidebarGroupDef[] = [
  {
    zh: '概览',
    en: 'Overview',
    items: [
...
// 「开发指南」区域侧边栏
const developmentGroups: SidebarGroupDef[] = [
  {
    zh: '开发指南',
    en: 'Development',
    items: [
...
// 侧边栏按区域分区:开始使用区域共用一套,使用指南/开发指南各自独立
const sidebarDef: Record<string, SidebarGroupDef[]> = {
  '/product': gettingStartedGroups,
  '/features': gettingStartedGroups,
  '/faq': gettingStartedGroups,
  '/getting-started': gettingStartedGroups,
  '/tutorials/': gettingStartedGroups,
  '/reference/': gettingStartedGroups,
  '/glossary': gettingStartedGroups,
  '/release-notes': gettingStartedGroups,
  '/troubleshooting': gettingStartedGroups,
  '/guides/': guidesGroups,
  '/development/': developmentGroups,
}
...
export default defineConfig({
  ...
  locales: {
    root: {
      ...
      themeConfig: {
        nav: [
          { text: '开始使用', link: '/product', activeMatch: '/product|/features|/faq|/getting-started|/tutorials/|/reference/|/glossary|/release-notes|/troubleshooting' },
    ...
    en: {
      ...
      themeConfig: {
        nav: [
          { text: 'Getting Started', link: '/en/product', activeMatch: '/en/product|/en/features|/en/faq|/en/getting-started|/en/tutorials/|/en/reference/|/en/glossary|/en/release-notes|/en/troubleshooting' },
